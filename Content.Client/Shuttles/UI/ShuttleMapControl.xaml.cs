...
public sealed partial class ShuttleMapControl : BaseShuttleControl
{
    ...
    public void SetMap(MapId mapId, bool recentering = false)
    {
        ViewingMap = mapId;
        ...
        if (mapBoundsQuery.TryGetComponent(viewedMapUid, out var mapBounds))
        {
            WorldMinRange = 256f;
            WorldMaxRange = mapBounds.Radius;
            WorldRange = mapBounds.Radius;
            ActualRadarRange = mapBounds.Radius;
        }
    }
